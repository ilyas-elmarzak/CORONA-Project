...
const result = document.querySelector('.container__titre')
let currentQuestionIndex = 0

answerInputs.addEventListener('change', typeButton)
...
nextBtn.addEventListener ('click',()=>{
    ...
    if (currentQuestionIndex===21){
        nextBtn.innerHTML='terminer le test'
        nextBtn.classList.add ('result')
        const doneTest = document.querySelector ('.result')
        doneTest.addEventListener('click',Results)
    }
})
